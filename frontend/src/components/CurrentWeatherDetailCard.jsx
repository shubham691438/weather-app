...
const CurrentWeatherDetailCard = ({currUnit,city,currTemperature,currFeelsLike,currHumidity,currMainCondition,currWindSpeed}) => {

  return (
    <div
        className="py-5 px-5 w-[385px] justify-between flex rounded-3xl shadow-2xl cursor-pointer transform ease-in-out bg-white/20 duration-500 backdrop-blur-sm   hover:scale-[105%]"
    >
        ...
        >
            ...
            <div className="">
            <p className="font-bold text-2xl text-right text-[#ff5a00]">{currMainCondition.substr(0, Math.min(7, currMainCondition.length))}</p>
